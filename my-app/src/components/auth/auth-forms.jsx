...
import { Eye, EyeOff, Upload, User, Mail, Phone, CreditCard, Camera } from "lucide-react"
  ...
  return (
    ...
    <div className="w-full max-w-md">
      <div className="text-center mb-8">
        ...
        <p className="text-slate-600 dark:text-slate-400 mt-2">Sign in to your account or create a new one</p>
      </div>
    <Tabs defaultValue="signin" value={activeTab} onValueChange={setActiveTab} className="w-full max-w-md mx-auto">
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input placeholder="3520112345678" className="pl-10" {...field} />
                      </div>
                    </FormControl>
                    <FormMessage />
                  </FormItem>
              ...
              <div>
                ...
                <div
                  className={cn(
                    ...
                    cnicFrontImage ? "border-primary" : "border-muted-foreground",
                  )}
                >
                  {cnicFrontImage ? (
                    <img
                    ...
                    <>
                      ...
                      <p className="text-sm text-muted-foreground">Upload CNIC front</p>
                    </>
                  )}
                </div>
                <Label
              ...
              <div>
                ...
                >
                  {cnicBackImage ? (
                    ...
                    <>
                      <Upload className="h-10 w-10 text-muted-foreground mb-2" />
                      <p className="text-sm text-muted-foreground">Upload CNIC back</p>
                    </>
                  )}
                </div>
                <Label
