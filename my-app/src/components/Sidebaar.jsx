import { setIsMobile, setSelectedCategory, setSidebarCollapsed, setSidebarOpen } from "@/redux/appSlice";
...
function NavItem({ icon, label, active = true, collapsed = false, category, nav }) {
  const navigate = useNavigate();  
    ...
    return (
      <div
        ...
        }`} onClick={() => { dispatch(setSelectedCategory(category)); navigate(nav); }}>
        <div className={`${active ? "text-cyan-600 dark:text-cyan-400" : ""}`}>{icon}</div>
